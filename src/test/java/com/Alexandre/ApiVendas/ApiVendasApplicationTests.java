package com.Alexandre.ApiVendas;
...
public class ApiVendasApplicationTests {
	...
	public static void setUpClass() {
		TestWatchman.watchman.registerClass(ApiVendasApplicationTests.class);
	}

	@AfterClass
	public static void tearDownClass() {
		TestWatchman.watchman.createReport(ApiVendasApplicationTests.class);
	}
